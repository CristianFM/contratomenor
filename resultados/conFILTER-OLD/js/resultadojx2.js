...
*/
    ...
    $('#botonmostraronda1').on('click' , function(){  
        var rondas = {ronda : 'ronda1'};
        var jsonRondas = JSON.stringify(rondas);
        ...
        function queryParams(params) {
            params.ronda = 'ronda1'; // add param1
    ...
    $('#botonmostraronda2').on('click' , function(){  
        var rondas = {ronda : 'ronda1'};
        var jsonRondas = JSON.stringify(rondas);
        ...
        function queryParams(params) {
            params.ronda = 'ronda2'; // add param1
            // console.log(JSON.stringify(params));
            // {"limit":10,"offset":0,"order":"asc","your_param1":1,"your_param2":2}
            return params;
        }
